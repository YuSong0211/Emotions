...
@interface REDSelectEmotionKindView()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation REDSelectEmotionKindView
...
-(void)configUI{
    ...
    _items = @[@"a", @"b", @"c", @"4", @"5", @"b", @"c", @"4", @"5", @"b", @"c", @"4", @"5",@"b", @"c",@"a", @"b", @"c", @"4", @"5", @"b", @"c", @"4", @"5", @"b", @"c", @"4", @"5",@"b", @"c",@"a", @"b", @"c", @"4", @"5", @"b", @"c", @"4", @"5", @"b", @"c", @"4", @"5",@"b", @"c",@"a", @"b", @"c", @"4", @"5", @"b", @"c", @"4", @"5", @"b", @"c", @"4", @"5",@"b", @"c"];
    NSLog(@"%f", _items.count / 10.0);
    _pageCount = _items.count;
    while (_pageCount % 10 != 0) {
        ++_pageCount;
    }
//    self.pageControl.numberOfPages = _pageCount / 10.0;
...
//        layout.sectionInset = UIEdgeInsetsMake(5, 5, 5, 5);
        _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(15, 0, kScreenWidth-30,kItemHeight * 2 + 4)  collectionViewLayout:layout];
